...
sample_dir = '/home/sthalham/data/renderings/linemod_limBG' #directory for temporary files (cam_L, cam_R, masks..~)
target_dir = '/home/sthalham/data/renderings/linemod_limBG'
index=0
isfile=True
while isfile:
