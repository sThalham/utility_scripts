        ...
        for ss in subsub:
            ...
            for obj in scene.objects:
                ...
                if obj.name =='Plane.Ground':
                    ...
                    obj_object.location.x= cam_T[0]*0.001 
                    obj_object.location.y=  cam_T[1]*0.001 + (offZ * cos(theta))
                    obj_object.location.z = cam_T[2]*0.001 + (offZ * sin(theta))
                ...
                if obj.name =='Plane.Room.001':
                    ...
                    obj_object.location.x= cam_T[0]*0.001 
                    obj_object.location.y=  cam_T[1]*0.001 - (offY * sin(theta))
                    obj_object.location.z = cam_T[2]*0.001 + (offY * cos(theta))
